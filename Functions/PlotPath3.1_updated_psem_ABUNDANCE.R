...
{  
  ...
  ab=cbind(c(51,69,69,51), c(16,16,23,23))
  polygon(ab[,1], ab[,2], col =  adjustcolor("lightblue",alpha.f = 1), border = "white")
  text(mean(ab[,1]),mean(ab[,2]), Species.name, cex = cex.text1) 
  ...
  coeffs <- e.coefs[e.coefs$Predictor== "crop_diver" & e.coefs$Response=="ab"  ,]
  
  if((coeffs$P.Value > 0.10)){
    arrows(x0=mean(ab[1:2,1])+6, x1=mean(ab[1:2,1])+6, y0=mean(crop_diver[3:2,2]), y1= mean(ab[c(2),2]), length = 0.1, 
           lwd= (abs(coeffs$Estimate))*3, 
           col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.25), adjustcolor(col.neg,alpha.f = 0.25)))
    segments(x0=mean(crop_diver[2,1]), x1=mean(ab[1:2,1])+6, y0=mean(crop_diver[3:2,2]), y1= mean(crop_diver[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3, 
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.25), adjustcolor(col.neg,alpha.f = 0.25))) }
  ...
  if((0.05 < coeffs$P.Value) & (coeffs$P.Value < 0.10)){
    ...
    segments(x0=mean(crop_diver[2,1]), x1=mean(ab[1:2,1])+6, y0=mean(crop_diver[3:2,2]), y1= mean(crop_diver[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3, 
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.5), adjustcolor(col.neg,alpha.f = 0.5)))
    text(mean(c(mean(crop_diver[2,1]),mean(ab[1:2,1])+6))  , mean(crop_diver[3:2,2])+1.2, round(coeffs$Estimate, digits = digits.estimate), cex=cex.estimate) }
  ...
  if((0.01 < coeffs$P.Value) & (coeffs$P.Value < 0.05)){
    ...
    segments(x0=mean(crop_diver[2,1]), x1=mean(ab[1:2,1])+6, y0=mean(crop_diver[3:2,2]), y1= mean(crop_diver[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3, 
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.75), adjustcolor(col.neg,alpha.f = 0.75)))
    text(mean(c(mean(crop_diver[2,1]),mean(ab[1:2,1])+6))  , mean(crop_diver[3:2,2])+1.2, labels = paste(round(coeffs$Estimate, digits = digits.estimate), "*"), cex=cex.estimate) }
  ...
  coeffs <- e.coefs[e.coefs$Predictor== "Fallow" & e.coefs$Response=="ab"  ,]
  
  if (coeffs$P.Value > 0.10){
    arrows(x0=mean(ab[1:2,1])+4, x1=mean(ab[1:2,1])+4, y0=mean(Fallow[3:2,2]), y1= mean(ab[c(2),2]), length = 0.1, 
           lwd= (abs(coeffs$Estimate))*3, 
           col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.25), adjustcolor(col.neg,alpha.f = 0.25)))
    segments(x0=mean(Fallow[2,1]), x1=mean(ab[1:2,1])+4, y0=mean(Fallow[3:2,2]), y1= mean(Fallow[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3, 
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.25), adjustcolor(col.neg,alpha.f = 0.25))) }
  ...
  if ((0.05 < coeffs$P.Value) & (coeffs$P.Value < 0.10)){
    ...
    segments(x0=mean(Fallow[2,1]), x1=mean(ab[1:2,1])+4, y0=mean(Fallow[3:2,2]), y1= mean(Fallow[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3, 
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.5), adjustcolor(col.neg,alpha.f = 0.5)))
    text(mean(c(mean(Fallow[2,1]),mean(ab[1:2,1])+4))  , mean(Fallow[3:2,2])+1.2, round(coeffs$Estimate, digits = digits.estimate), cex=cex.estimate) }
  ...
  if ((0.01 < coeffs$P.Value) & (coeffs$P.Value < 0.05)){
    ...
    segments(x0=mean(Fallow[2,1]), x1=mean(ab[1:2,1])+4, y0=mean(Fallow[3:2,2]), y1= mean(Fallow[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3, 
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.75), adjustcolor(col.neg,alpha.f = 0.75)))
    text(mean(c(mean(Fallow[2,1]),mean(ab[1:2,1])+4))  , mean(Fallow[3:2,2])+1.2, labels = paste(round(coeffs$Estimate, digits = digits.estimate), "*"), cex=cex.estimate) }
  ...
  coeffs <- e.coefs[e.coefs$Predictor== "par" & e.coefs$Response=="ab"  ,]
  
  if(coeffs$P.Value > 0.10){
    arrows(x0=mean(ab[1:2,1])+1, x1=mean(ab[1:2,1])+1, y0=mean(par[3:2,2]), y1= mean(ab[c(2),2]), length = 0.1, 
           lwd= (abs(coeffs$Estimate))*3, 
           col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.25), adjustcolor(col.neg,alpha.f = 0.25)))
    segments(x0=mean(par[2,1]), x1=mean(ab[1:2,1])+1, y0=mean(par[3:2,2]), y1= mean(par[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3, 
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.25), adjustcolor(col.neg,alpha.f = 0.25))) }
  ...
  if ((0.05 < coeffs$P.Value) & (coeffs$P.Value < 0.10)){
    ...
    segments(x0=mean(par[2,1]), x1=mean(ab[1:2,1])+1, y0=mean(par[3:2,2]), y1= mean(par[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3,
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.5), adjustcolor(col.neg,alpha.f = 0.5)))
    text(mean(c(mean(par[2,1]),mean(ab[1:2,1])+1))  , mean(par[3:2,2])+1.2, round(coeffs$Estimate, digits = digits.estimate), cex=cex.estimate)}
  ...
  if ((0.01 < coeffs$P.Value) & (coeffs$P.Value < 0.05)){
    ...
    segments(x0=mean(par[2,1]), x1=mean(ab[1:2,1])+1, y0=mean(par[3:2,2]), y1= mean(par[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3,
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.75), adjustcolor(col.neg,alpha.f = 0.75)))
    text(mean(c(mean(par[2,1]),mean(ab[1:2,1])+4))  , mean(par[3:2,2])+1.2, labels = paste(round(coeffs$Estimate, digits = digits.estimate), "*"), cex=cex.estimate) }
  ...
  coeffs <- e.coefs[e.coefs$Predictor== "tbl" & e.coefs$Response=="ab"  ,]
  
  if(coeffs$P.Value > 0.10){
    arrows(x0=mean(ab[1:2,1])-1, x1=mean(ab[1:2,1])-1, y0=mean(tbl[3:2,2]), y1= mean(ab[c(2),2]), length = 0.1, 
           lwd= (abs(coeffs$Estimate))*3, 
           col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.25), adjustcolor(col.neg,alpha.f = 0.25)))
    segments(x0=mean(tbl[2,1]), x1=mean(ab[1:2,1])-1, y0=mean(tbl[3:2,2]), y1= mean(tbl[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3, 
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.25), adjustcolor(col.neg,alpha.f = 0.25)))}
  ...
  if ((0.05 < coeffs$P.Value) & (coeffs$P.Value < 0.10)){
    ...
    segments(x0=mean(tbl[2,1]), x1=mean(ab[1:2,1])-1, y0=mean(tbl[3:2,2]), y1= mean(tbl[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3,
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.5), adjustcolor(col.neg,alpha.f = 0.5)))
    text(mean(c(mean(tbl[2,1]),mean(ab[1:2,1])-1))  , mean(tbl[3:2,2])+1.2, round(coeffs$Estimate, digits = digits.estimate), cex=cex.estimate)}
  ...
  if ((0.01 < coeffs$P.Value) & (coeffs$P.Value < 0.05)){
    ...
    segments(x0=mean(tbl[2,1]), x1=mean(ab[1:2,1])-1, y0=mean(tbl[3:2,2]), y1= mean(tbl[3:2,2]),
             lwd= (abs(coeffs$Estimate))*3,
             col=ifelse(coeffs$Estimate>0, adjustcolor(col.pos,alpha.f = 0.75), adjustcolor(col.neg,alpha.f = 0.75)))
    text(mean(c(mean(tbl[2,1]),mean(ab[1:2,1])-1))  , mean(tbl[3:2,2])+1.2, labels = paste(round(coeffs$Estimate, digits = digits.estimate), "*"), cex=cex.estimate)}
  ...
  # arrows(x0=Treatment[2,1], x1=ab[1,1], y0=mean(Treatment[2:3,2]), y1= mean(ab[c(1,4),2]),length = 0.1)
  ...
  #from vegetation 
  # arrows(x0=mean(Diver[c(2),1]), x1=mean(ab[1:2,1]), y0=mean(Diver[3:2,2]), y1= mean(ab[c(4),2]),length = 0.1)
  # arrows(x0=mean(Heter[c(2),1]), x1=mean(ab[1:2,1]), y0=mean(Heter[3:2,2]), y1= mean(ab[c(4),2]),length = 0.1)
  # arrows(x0=mean(Height[c(2),1]), x1=mean(ab[1:2,1]), y0=mean(Height[3:2,2]), y1= mean(ab[c(4),2]),length = 0.1)
  # arrows(x0=mean(Cover[c(2),1]), x1=mean(ab[1:2,1]), y0=mean(Cover[3:2,2]), y1= mean(ab[c(4),2]),length = 0.1)
  # arrows(x0=mean(Cover_dead[c(2),1]), x1=mean(ab[1:2,1]), y0=mean(Cover_dead[3:2,2]), y1= mean(ab[c(4),2]),length = 0.1)
  ...
  #from food
  # arrows(x0=SAI_sd[3,1], x1=ab[1,1], y0=SAI_sd[3,2], y1= ab[1,2],length = 0.1)
  # arrows(x0=LAI_sd[3,1], x1=ab[1,1], y0=LAI_sd[3,2], y1= ab[1,2],length = 0.1)
  # arrows(x0=biom[3,1], x1=ab[1,1], y0=biom[3,2], y1= ab[1,2],length = 0.1)
  # 
