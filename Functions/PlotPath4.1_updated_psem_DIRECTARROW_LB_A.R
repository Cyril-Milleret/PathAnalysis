...
{  
  ...
  response <- c("Pres", "LAI_sd","biom","Diver","Heter","Height","Cover","Cover_dead",
                rep("Pres",5),
                rep("biom", 5),
                rep("biom", 4),
                rep("Pres",2),
  ...
  x1= c(mean(Pres[1:2,1],LAI_sd[1,1], biom[1,1], Diver[1,1], Heter[1,1], Height[1,1], Cover[1,1], Cover_dead[1,1],
